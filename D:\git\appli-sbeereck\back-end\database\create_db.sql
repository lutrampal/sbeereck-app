...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `member_list` (`member_id` INT, `first_name` INT, `last_name` INT, `balance` INT, `last_membership_payment` INT, `is_former_staff` INT);
...
SELECT member_id, first_name, last_name, balance, last_membership_payment, is_former_staff
	FROM members
    WHERE is_deleted = 0
