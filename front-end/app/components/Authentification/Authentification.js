    ...
    render() {
        return (
            <View style={{width: '100%', height: 'auto', padding: 10}}>
                ...
                <TextInput underlineColorAndroid='rgba(0,0,0,0)' autoCorrect={false} keyboardType='url' style={styles.textInput} onChangeText={this.props.editAppHost} value={this.props.appHost} placeholder="Serveur" />
